...
void Signatures::FindAll() {
	...
	pointerMap[Sigs::CBloonsBaseScreen_Init] = Signatures::FindFirst(1,
		"55 8b ec 6a ?? 68 ?? ?? ?? ?? 64 a1 ?? ?? ?? ?? 50 83 ec ?? a1 ?? ?? ?? ?? 33 c5 89 45 ?? 53 56 57 50 8d 45 ?? 64 a3 ?? ?? ?? ?? 8b d9 ff 75 ?? e8"
	);
	/* CBloonsTD5Game */
	...
	/* CCollectableTask */
	pointerMap[Sigs::CCollectableTask_VTable] = (void*)h_rtti::get_vtable("CCollectableTask");
	...
	/* CCompoundSprite */
	pointerMap[Sigs::CCompoundSprite_VTable] = (void*)h_rtti::get_vtable("CCompoundSprite");
	pointerMap[Sigs::CCompoundSprite_CCTOR] = Signatures::FindFirst(1,
		"55 8b ec 6a ? 68 ? ? ? ? 64 a1 ? ? ? ? 50 51 56 57 a1 ? ? ? ? 33 c5 50 8d 45 ? 64 a3 ? ? ? ? 8b f1 89 75 ? 8b 45" //Kong 4.2
	);
	pointerMap[Sigs::CCompoundSprite_Load] = Signatures::FindFirst(1,
		"55 8b ec 6a ? 68 ? ? ? ? 64 a1 ? ? ? ? 50 83 ec ? 53 56 57 a1 ? ? ? ? 33 c5 50 8d 45 ? 64 a3 ? ? ? ? 8b f1 89 75 ? e8 ? ? ? ? 8b 7d" //Kong 4.2
	);
	/* CDGSplashScreen */
	...
	pointerMap[Sigs::CEffectTask_FireAt] = Signatures::FindFirst(1,
		"55 8b ec 83 e4 ? 83 ec ? 53 56 57 8b f9 89 7c 24 ? 83 bf"
	);
	/* CFile */
	...
	/* C_GameSFXManager */
	pointerMap[Sigs::C_GameSFXManager_GetInstance] = Signatures::FindFirst(1,
		"55 8b ec 6a ? 68 ? ? ? ? 64 a1 ? ? ? ? 50 51 a1 ? ? ? ? 33 c5 50 8d 45 ? 64 a3 ? ? ? ? a1 ? ? ? ? 85 c0 75 ? 68 ? ? ? ? e8 ? ? ? ? 83 c4 ? 89 45 ? c7 45"
		// XRef sig: e8 ? ? ? ? 8b c8 ff 74 b0
	);
	pointerMap[Sigs::C_GameSFXManager_Play] = Signatures::FindFirst(1,
		"55 8b ec 83 e4 ? 51 53 56 57 8b f9 80 3f"
		// XRef sig: e8 ? ? ? ? 8b b7 ? ? ? ? 83 be
	);
	/* CGlueStatusEffect */
	...
	/* CNapalmStatusEffect */
	pointerMap[Sigs::CNapalmStatusEffect_VTable] = (void*)h_rtti::get_vtable("CNapalmStatusEffect");
	/* CPlayerProfileV1 */
